...
public class Contact {
    ...
    public static List<Contact> getEnglishContacts() {
        ...
        contacts.add(new Contact("M", "Lisa"));
        contacts.add(new Contact("M", "Lisa"));
        contacts.add(new Contact("M", "Lisa"));
        contacts.add(new Contact("M", "Lisa"));
        contacts.add(new Contact("N", "Lisa"));
        contacts.add(new Contact("N", "Lisa"));

        contacts.add(new Contact("O", "Lisa"));
        contacts.add(new Contact("O", "Lisa"));

        contacts.add(new Contact("P", "Paul"));
        contacts.add(new Contact("P", "Peter"));
        contacts.add(new Contact("Q", "Lisa"));
        contacts.add(new Contact("Q", "Lisa"));
        contacts.add(new Contact("Q", "Lisa"));
        contacts.add(new Contact("R", "Lisa"));
        contacts.add(new Contact("R", "Lisa"));
        contacts.add(new Contact("R", "Lisa"));
        contacts.add(new Contact("S", "Lisa"));
        contacts.add(new Contact("S", "Lisa"));
        contacts.add(new Contact("S", "Lisa"));
